...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="body-main-content">
        <asp:GridView ID="GridView1" runat="server" HeaderStyle-CssClass="colum-header" BorderWidth="1px" runat="server" AutoGenerateColumns="False" Width="100%">
            <Columns>
                <asp:BoundField ItemStyle-CssClass="table-shareholders-colum" HeaderText="Full Name" DataField="EmployeeName" />
                ...
                <asp:BoundField ItemStyle-CssClass="table-shareholders-colum" HeaderText="Maximum Number Of Days Off" DataField="MaximumofNumberdayoff"/>
            </Columns>
        </asp:GridView>
    </div>
</asp:Content>
